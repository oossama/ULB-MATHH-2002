...
\section{Variables aléatoires particulières}
	\subsection{Binomiales et variables de Bernoulli}
		...
		\subsubsection{stabilité des binomiales}
			...
			deux variables de même type donnent une troisième variable de ce même type. Une bonne manière de procéder à cela est de regarder la fonction génératrice des moments
